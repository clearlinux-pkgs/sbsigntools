...
Source0  : https://git.kernel.org/pub/scm/linux/kernel/git/jejb/sbsigntools.git/snapshot/sbsigntools-0.9.4.tar.gz
...
%prep
%setup -q -n sbsigntools-0.9.4
cd %{_builddir}
tar xf %{_sourcedir}/b1f28e17227f2320d07fe052a8a48942fe17caa5.tar.gz
cd %{_builddir}/sbsigntools-0.9.4
mkdir -p lib/ccan.git
cp -r %{_builddir}/ccan-b1f28e17227f2320d07fe052a8a48942fe17caa5/* %{_builddir}/sbsigntools-0.9.4/lib/ccan.git
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593057088
...
cp %{_builddir}/sbsigntools-0.9.4/COPYING %{buildroot}/usr/share/package-licenses/sbsigntools/2e42353f981d6faf41d53432b53cff0276850c0d
cp %{_builddir}/sbsigntools-0.9.4/LICENSE.GPLv3 %{buildroot}/usr/share/package-licenses/sbsigntools/a6adc13d0c809ab8cb68e6e3b6eb7571bd0e2920
%make_install
